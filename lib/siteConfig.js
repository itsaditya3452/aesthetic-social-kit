// Update this to your real deployed domain before going live.
// It powers canonical URLs, Open Graph tags, the sitemap, and robots.txt.
export const SITE_URL = 'https://aestheticsocialkit.com';

export const SITE_NAME = 'Aesthetic Social Kit';

export const SITE_TITLE =
  'Aesthetic Social Kit — Free Instagram Story Maker, Reels Script Generator & Caption Studio';

export const SITE_DESCRIPTION =
  'Create animated Instagram story templates, generate viral Reels & TikTok scripts with a hook-retention-CTA framework, and format high-converting captions with an engagement score — 100% free, no login, runs entirely in your browser.';
